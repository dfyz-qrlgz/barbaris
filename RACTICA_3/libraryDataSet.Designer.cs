...
namespace RACTICA_3.libraryDataSetTableAdapters {
...
SELECT author_id, author_name, author_email FROM authors WHERE (author_id = @author_id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::RACTICA_3.Properties.Settings.Default.libraryConnectionString;
        }
...
SELECT book_id, book_title, author_id, book_published_date FROM books WHERE (book_id = @book_id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[1] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[1].Connection = this.Connection;
            this._commandCollection[1].CommandText = "DELETE FROM [dbo].[books] WHERE ([book_id] = @Original_book_id)";
            this._commandCollection[1].CommandType = global::System.Data.CommandType.Text;
